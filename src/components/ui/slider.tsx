...
import { cn } from "@allocado/lib/utils";
...
function Slider({
  ...
  /** Accessible name for each thumb, by index — names the boundary it controls. */
  thumbLabels?: string[];
    ...
    >
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          // biome-ignore lint/suspicious/noArrayIndexKey: thumb count/order is derived from the value array itself
          key={index}
